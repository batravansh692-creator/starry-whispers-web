...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Saptarishis Astrology by Soniya Sharma" },
      { property: "og:description", content: "Authentic Vedic astrology consultations in Greater Noida West, Ghaziabad." },
